...
export async function POST(request: Request) {
  ...
  try {
    ...
    const linkExist = await prisma.socialLink.findMany({
      where: {
    ...
    if (resumeExist) {
      ...
      const newresume = await prisma.resume.create({
        ...
        include: {
          socialLinks: true, // Include all posts in the returned object
        },
      });
